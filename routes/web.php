...
Route::get('/patient/attachment/download/{id}', [PatientController::class, 'downloadAttachment'])->name('patient.attachment.download')->middleware(['auth', 'admin']);
        ...
        Route::get('/forms', [DashboardController::class, 'forms'])->name('page.forms')->middleware(['auth', 'admin']);

Route::post('/forms/generate', [DashboardController::class, 'generate'])->name('forms.generate')->middleware(['auth', 'admin']);

Route::get('/generated-forms', function () {

    $files = collect(Storage::files('public/generated_forms'))
...
})->name('forms.generated.list')->middleware(['auth', 'admin']);

Route::post('/forms/generated/delete', [DashboardController::class, 'deleteGenerated'])->name('forms.generated.delete')->middleware(['auth', 'admin']);
...
Route::post('/patient/profile-image/upload', [PatientController::class, 'uploadProfileImage'])
    ->name('patient.profile.image.upload');
