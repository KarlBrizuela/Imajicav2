...
>
  <head>
    ...
    <title>Imajica Booking System - Edit Branch</title>
                          ...
                          <form method="post" action="{{ route('branch.update') }}">
                            ...
                            <div class="row">
                              <div class="col-12 d-flex gap-3">
                                <button type="submit" class="btn btn-primary" id="updateBtn">Update Branch</button>
                                <a href="{{ route('page.branch-list') }}" class="btn btn-outline-secondary">Cancel</a>
                              </div>
                            </div>
                          </form>
                        </div>
